...
const plans = [
  {
    ...
    price: '$29',
    period: '/month',
    desc: 'Perfect for solo instructors and small creators getting started.',
    color: '#22d9a7',
    features: [
      '5 courses',
      'Up to 200 students',
  ...
  },
  {
    ...
    price: '$79',
    period: '/month',
    desc: 'The best choice for growing academies and professional educators.',
    color: '#7c5cfc',
    features: [
      'Unlimited courses',
      'Unlimited students',
  ...
  },
  {
    ...
    price: 'Custom',
    period: '',
    desc: 'Built for corporates, universities, and large training organizations.',
    color: '#c471ed',
    features: [
      'Everything in Pro',
      'SSO / SAML auth',
